...
const HeaderBottom = () => {
  ...
  const [selectedItem, setSelectedItem] = useState<any>('Michigan');
  ...
  const menu = (
    ...
    >
      <MenuItem key="Alabama">Alabama</MenuItem>
      <MenuItem key="Alaska">Alaska</MenuItem>
      <MenuItem key="Arizona">Arizona</MenuItem>
      <MenuItem key="Arkansas">Arkansas</MenuItem>
      <MenuItem key="California">California</MenuItem>
      <MenuItem key="Colorado">Colorado</MenuItem>
      <MenuItem key="Connecticut">Connecticut</MenuItem>
      <MenuItem key="Delaware">Delaware</MenuItem>
      <MenuItem key="Florida">Florida</MenuItem>
      <MenuItem key="Georgia">Georgia</MenuItem>
      <MenuItem key="Hawaii">Hawaii</MenuItem>
      <MenuItem key="Idaho">Idaho</MenuItem>
      <MenuItem key="Illinois">Illinois</MenuItem>
      <MenuItem key="Indiana">Indiana</MenuItem>
      <MenuItem key="Iowa">Iowa</MenuItem>
      <MenuItem key="Kansas">Kansas</MenuItem>
      <MenuItem key="Kentucky">Kentucky</MenuItem>
      <MenuItem key="Louisiana">Louisiana</MenuItem>
      <MenuItem key="Maine">Maine</MenuItem>
      <MenuItem key="Maryland">Maryland</MenuItem>
      <MenuItem key="Massachusetts">Massachusetts</MenuItem>
      <MenuItem key="Michigan">Michigan</MenuItem>
      <MenuItem key="Minnesota">Minnesota</MenuItem>
      <MenuItem key="Mississippi">Mississippi</MenuItem>
      <MenuItem key="Missouri">Missouri</MenuItem>
      <MenuItem key="Montana">Montana</MenuItem>
      <MenuItem key="Nebraska">Nebraska</MenuItem>
      <MenuItem key="Nevada">Nevada</MenuItem>
      <MenuItem key="New Hampshire">New Hampshire</MenuItem>
      <MenuItem key="New Jersey">New Jersey</MenuItem>
      <MenuItem key="New Mexico">New Mexico</MenuItem>
      <MenuItem key="New York">New York</MenuItem>
      <MenuItem key="North Carolina">North Carolina</MenuItem>
      <MenuItem key="North Dakota">North Dakota</MenuItem>
      <MenuItem key="Ohio">Ohio</MenuItem>
      <MenuItem key="Oklahoma">Oklahoma</MenuItem>
      <MenuItem key="Oregon">Oregon</MenuItem>
      <MenuItem key="Pennsylvania">Pennsylvania</MenuItem>
      <MenuItem key="Rhode Island">Rhode Island</MenuItem>
      <MenuItem key="South Carolina">South Carolina</MenuItem>
      <MenuItem key="South Dakota">South Dakota</MenuItem>
      <MenuItem key="Tennessee">Tennessee</MenuItem>
      <MenuItem key="Texas">Texas</MenuItem>
      <MenuItem key="Utah">Utah</MenuItem>
      <MenuItem key="Vermont">Vermont</MenuItem>
      <MenuItem key="Virginia">Virginia</MenuItem>
      <MenuItem key="Washington">Washington</MenuItem>
      <MenuItem key="West Virginia">West Virginia</MenuItem>
      <MenuItem key="Wisconsin">Wisconsin</MenuItem>
      <MenuItem key="Wyoming">Wyoming</MenuItem>
    </Menu>
  );
