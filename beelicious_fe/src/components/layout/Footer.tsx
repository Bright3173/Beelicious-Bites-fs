                            ...
                            <Row className="m-minus-991">
                                <Col lg={3} className="bb-footer-cat col-12">
                                    <div className="bb-footer-widget bb-footer-company">
                                        <img src="/assets/img/logo/pastry-logo-2.jpg" className="bb-footer-logo" alt="footer logo" />
                                        <img src="/assets/img/logo/logo-dark.png" className="bb-footer-dark-logo" alt="footer logo" />
                                        <p className="bb-footer-detail">Beelicious Bite is striving to be one of the biggest pastry store. Get
                                            ...
                                            >
                                                <ul className="align-items-center">
                                                    ...
                                                    <li className="bb-footer-link bb-foo-call">
                                                        ...
                                                        <Link href="tel:+12693529877">+1 (269) 352-9877</Link>
                                                    </li>
                                                    <li className="bb-footer-link bb-foo-mail">
                                                        <span>
                                                            <i className="ri-mail-line"></i>
                                                        </span>
                                                        <Link href="mailto:blexnnky@gmail.com">blexnnky@gmail.com</Link>
                                                    </li>
                                                </ul>
                                            </motion.div>
                                        </div>
                                ...
                                <div className="bb-bottom-info">
                                    <div className="footer-copy">
                                        <div className="footer-bottom-copy ">
                                            <div className="bb-copy">Copyright © <span id="copyright_year">2025 </span>
                                                <Link className="site-name" href="/">Beelicious Bite</Link> all rights reserved.
                                            </div>
                                        </div>
                                    </div>
