                            ...
                            <Col sm={12}>
                                <div className="bb-category-tags">
                                    <div className="sub-title">
                                        <h4>keywords (flavors)</h4>
                                    </div>
                                    <div className="bb-tags">
                                        <ul>
                                           
                                            <li>
                                                <a onClick={(e) => e.preventDefault()} href="#">Banana</a>
                                            </li>
                                            <li>
                                                <a onClick={(e) => e.preventDefault()} href="#">Nut</a>
                                            </li>
                                            <li>
                                                <a onClick={(e) => e.preventDefault()} href="#">Biscuit</a>
                                            </li>
                                            <li>
                                                <a onClick={(e) => e.preventDefault()} href="#">Chocolaty</a>
                                            </li>
